...
xlabel('$X_B$', 'Interpreter', 'latex')
ylabel('$\Delta H^m \ (J/mol)$', 'Interpreter', 'latex')
legend('$\Delta H^m$', 'Tangent at $X_B=0.25$', 'Interpreter', 'latex', 'Location', 'northwest')
...
xlabel('$X_B$', 'Interpreter', 'latex')
ylabel('$\Delta H^m \ (J/mol)$', 'Interpreter', 'latex')
legend('$\Delta H^m$', 'Tangent at $X_B=0.50$', 'Interpreter', 'latex', 'Location', 'northwest')
...
xlabel('$X_B$', 'Interpreter', 'latex')
ylabel('$\Delta H^m \ (J/mol)$', 'Interpreter', 'latex')
legend('$\Delta H^m$', 'Tangent at $X_B=0.75$', 'Interpreter', 'latex', 'Location', 'northwest')
